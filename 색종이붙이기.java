	...
	public static void square(int pos, int cnt) {
		...
		if(map[y][x] == 1) {
			for(int color = 5; color > 0 ; color-=1 ) {
				if(color_simul(y,x,color) && color_square[color] > 0) { // ä��� ������?
					color_fill(y,x,color,0); // 1�� ä���
					color_square[color]--;   // color��° ��Ҹ� ���� ��Ų��.
					square(pos+1,cnt+1);
					color_fill(y,x,color,1); // ���ٿ����� 0���� ä��� 
					color_square[color]++;   // �ٽ� ������Ų��.
				}
			}	
		}
